                                    ...
                                    isAuthenticated ?
                                        (
                                            <div className=' '>
                                                ...
                                                {operAccountDropDown &&
                                                    <ul role="menu"
                                                        class="absolute z-10  flex min-w-[180px] flex-col gap-2 right-4 top-16 rounded-md border border-blue-gray-50 bg-white p-3 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none">
                                                        ...
                                                        <button role="menuitem"
                                                            ...
                                                            <p  onClick={()=> signOut(getAuth(app))} class="block font-sans text-sm antialiased font-medium leading-normal text-inherit">
                                                                Sign Out
                                                            </p>
                                                        </button>
                                                    </ul>}
